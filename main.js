...
answerElement.classList.add('fade', 'text-center', 'fs-1', 'fw-bold', 'display-4', 'bg-warning', 'px-2', 'py-5' , 'rounded', 'text-white', 'p-2', 'w-50', 'position-absolute', 'top-50', 'start-50', 'translate-middle')
